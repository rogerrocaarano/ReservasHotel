...
namespace SistemaHotel.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombres,Apellidos,Genero,RazonSocial,NroRazonSocial,Email,Telefono")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombres,Apellidos,Genero,RazonSocial,NroRazonSocial,Email,Telefono")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
